...
通过**生成的技能能力注册表**,把任务路由到最合适的已安装 skill。面向大型技能库由统一工具管理(本机:CC Switch + Claude Code)的环境 —— 845 个技能、17 个分类、一张薄发现表。
...
- `scripts/generate_router.py` 仅用标准库,已验证(867 行源 → 845 规范条目,0 错误)。
